...
/**
 * A kryo {@link Serializer} for unmodifiable {@link Collection}s and
 * {@link Map}s created via {@link Collections}.
 * 
...
public class UnmodifiableCollectionsSerializer extends Serializer<Object> {
	...
	public void write(final Kryo kryo, final Output output, final Object object) {
		try {
			...
			// the ordinal could be replaced by s.th. else (e.g. a explicitely
			// managed "id")
