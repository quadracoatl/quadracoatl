...
public class Configuration {
	...
	public double getDouble(String key, double defaultValue) {
		...
		try {
			...
			Logger.info(e, "Property '{}' with value '{}' is not a double.", key, value);
	...
	public float getFloat(String key, float defaultValue) {
		...
		try {
			...
			Logger.info(e, "Property '{}' with value '{}' is not a float.", key, value);
	...
	public int getInteger(String key, int defaultValue) {
		...
		try {
			...
			Logger.info(e, "Property '{}' with value '{}' is not an integer.", key, value);
	...
	public long getLong(String key, int defaultValue) {
		...
		try {
			...
			Logger.info(e, "Property '{}' with value '{}' is not a long.", key, value);
	...
	public void load(Path propertiesFile) {
		try (FileInputStream stream = new FileInputStream(propertiesFile.toFile())) {
			...
			Logger.error(e, "Could not read property file from '{}'.", propertiesFile.toAbsolutePath());
		}
	}
	...
	public void store(Path propertiesFile) {
		try (FileOutputStream stream = new FileOutputStream(propertiesFile.toFile())) {
			...
			Logger.error(e, "Could not write property file to '{}'.", propertiesFile.toAbsolutePath());
		}
	}
}
